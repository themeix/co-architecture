 ...
 * Released under the MIT license.
 * http://jquery.org/license
 */!1!==t.uiBackCompat&&t.effects.define("transfer",(function(e,i){t(this).transfer(e,i)}))})),function(t){"use strict";t(window).on("load",(function(){t(".preloader").fadeOut(10)})),t(window).on("scroll",(function(){t(window).scrollTop()>=0?t(".header-bottombar").addClass("header-sticky"):t(".header-bottombar").removeClass("header-sticky")})),t(".header-cart,.sidebar-close").on("click",(function(){t("#sidebar-navbar-area").toggleClass("active"),t("body").toggleClass("sidebar-before-bg")})),t(".mobile-toggle").on("click",(function(){t(this).toggleClass("open"),t(".toggle-menu-class").slideToggle()})),t(".toggle").on("click",(function(){t(this).text().includes("-")?t(this).text("+"):t(this).text("-"),t(this).parent().siblings(".submenu").slideToggle()})),t(".container-video, .video-container").fitVids(),t("#accordion").accordion(),AOS.init({offset:50,delay:0,duration:400,easing:"ease-in-out",debounceDelay:20,throttleDelay:50,once:!0,mirror:!1,anchorPlacement:"top-bottom"})}(jQuery);